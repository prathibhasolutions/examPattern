...
urlpatterns = [
    ...
    path('<int:draft_id>/import-images/', views.import_images_to_draft, name='import_images_to_draft'),
    ...
    path('<int:draft_id>/api/question/<int:question_id>/toggle-bonus/', views.api_toggle_bonus, name='api_toggle_bonus'),
